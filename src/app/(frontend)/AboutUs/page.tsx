  ...
  return (
    <div>
      <div className='w-screen relative'>
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-3/4 lg:-translate-y-1/2 text-white text-xl lg:text-5xl text-center font-extrabold w-full">Start with us the body and</div>
      ...
      <div className='w-full h-fit flex flex-col mt-[10%] justify-end  items-center lg:items-end'>
        ...
        <div className='w-full h-fit flex flex-col lg:flex-row '>
          ...
          <div className="w-full lg:w-1/2 p-[40px] py-[5px] flex flex-col justify-start items-center">

            <div className='text-[#BCBCBC] mb-[30px] '>The studio has a dedicated team of fitness professionals and trainers who strive to achieve their client’s goals and ensure all the clients reach their maximum potential. The entire team is extremely dedicated and passionate about fitness. This sheer love for fitness makes them highly motivated, positive and enthusiastic, making sure each client achieves not only their fitness goals but goes beyond their capabilities, while ensuring an extremely enjoyable fitness journey.</div>
        ...
        <div className='flex justify-center items-center flex-col gap-9 py-12'>
          <div className='w-full h-fit flex flex-col lg:flex-row justify-around items-center gap-4 '>
            ...
            <div className='flex flex-col justify-center items-center '>                 
              <div className='font-semibold text-sm text-black  border p-2 border-[#E2F163] border-2 rounded-[80px] h-fit cursor-pointer bg-[#E2F163] '>Book A Trial</div>
            </div>
          </div>
          <div className='w-full lg:w-[75%] h-fit flex flex-col lg:flex-row justify-around items-center gap-6'>
