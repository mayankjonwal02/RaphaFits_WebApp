  ...
  return (
    <div>
      <div className='w-full relative'>
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-5xl font-extrabold">Start with us the body and</div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 translate-y-[60%] text-white text-5xl font-extrabold">mind clensing</div>
        <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 translate-y-[25%] text-white text-5xl font-extrabold bg-white flex flex-row gap-4 p-7 w-1/2 justify-center '>
          <img src={img2.src} alt="img2" className="w-1/3 " />
          <img src={img3.src} alt="img3" className="w-2/3 " />
        </div>
      </div>

      <div className='w-full h-fit flex flex-col mt-[30%] justify-start'>

        <div className="text-5xl font-semibold text-black mb-[1px] px-[40px]">About Us</div>
        <div className='w-full h-fit flex flex-row '>
          <div className="w-1/2 p-[40px]  flex flex-col justify-center items-center">
          ...
          <div className="w-1/2 h-full p-[40px] ">
      ...
      <div className='w-full h-fit flex flex-col mt-[10%] justify-end  items-end'>

        <div className="text-5xl font-semibold text-black mb-[1px] px-[40px]">TEAM OF FITNESS</div>

        <div className='w-full h-fit flex flex-row '>
          <div className="w-1/2 h-full p-[40px] ">
            <img src={img5.src} alt="img5" className="w-full" />
          </div>
          <div className="w-1/2 p-[40px]  flex flex-col justify-start items-center">
      ...
      <div className='w-full h-fit flex flex-col mt-[20%] bg-[#7E6D5B]'>
        ...
        <div className='flex justify-center items-center flex-col gap-9 py-12'>
          ...
          <div className='w-[75%] h-fit flex flex-row justify-around items-center '>
