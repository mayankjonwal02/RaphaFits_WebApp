...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center w-screen">
      ...
      <div className="flex flex-row justify-center items-center my-5 w-full gap-3">
        <div className='font-bold text-md md:text-xl text-black py-1 md:py-3 px-4 md:px-6 border border-[#E2F163] border-2 rounded-[50px] h-fit  cursor-pointer bg-[#E2F163] text-customtext'>Book a Trial</div>
        <div className='font-bold text-md md:text-xl text-black py-1 md:py-3 px-4 md:px-8 border border-customtext border-2 rounded-[50px] h-fit  cursor-pointer bg-white text-customtext' onClick={() => router.push('/AboutUs')}>About Us</div>
      ...
      <div className="flex flex-col lg:flex-row w-full mt-[50px]">
        <div className="flex flex-col -full lg:w-1/2 p-[40px]">
          ...
          <div className="bg-[#958574] text-white p-[30px] mt-[70px] gap-[20px] flex flex-col">
      ...
      <div className="flex flex-row w-full mt-[100px]">
        ...
        <div className="flex flex-col w-full lg:w-1/2 p-[40px]">
          ...
          <div className="bg-[#F0F0F0] w-full p-[30px] mt-[70px] gap-[36.73px] flex flex-col justify-center items-center">
            <div className="w-[100%] bg-red-300"><img src={img4.src} alt="img4" className="w-full" /></div>
            <div className="w-[100%] flex flex-col gap-3">

              <div className="text-3xl font-bold text-center">Vision</div>
              <div className="text-[15px]  text-[#6A6A6A] text-center"> We aim to inspire positive change, one mindful movement at a time.</div>
            </div>
      ...
      <div className="flex flex-col lg:flex-row justify-around items-start lg:items-center w-full p-4 gap-4 md:gap-2">
              <div className="flex flex-row bg-[#F3F3F3] justify-start items-center gap-3 px-3 py-2 w-full">
                <div className="bg-black text-white p-3">01</div>
                <div>Personal Attention</div>
              </div>

              <div className="flex flex-row bg-[#F3F3F3] justify-start w-full items-center gap-3 px-3 py-2">
      ...
      <div className="flex flex-col w-full lg:w-5/6 p-[40px] mt-[100px]">
          <div className="text-[17px]  text-[#524FF5] font-mono">OUR FITNESS TRAINING</div>
          <div className="text-[25px] font-bold text-black ">Discover the power of Rapha-fit Pilates</div>
        ...
        <div className="flex flex-col mt-4 lg:mt-10 justify-center items-center w-full">
              ...
              <div className="text-center text-md max-w-[300px] md:max-w-[750px] my-4">Our comprehensive Pilates instructor training programs includes both mat and reformer Pilates. You will be trained by the best instructor who will mentor you on your education path. Join us and let your love for Pilates become the foundation of your career journey.</div>
              <div className="bg-[#7E6D5B] w-full h-[300px] md:h-[500px] mt-[100px] md:mt-[250px] flex flex-column justify-center items-center">
                <div className="w-2/3 transform  -translate-y-[50px] flex flex-col justify-center items-center">
                <img src = {img9.src} alt="img9" className="w-full " />
                <div className='font-bold text-md md:text-xl text-black p-3 border border-[#E2F163] border-2 rounded-[80px] h-fit w-fit mx-7 mt-[80px] cursor-pointer bg-[#E2F163]'>Enquire Now</div>
