...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center ">
      ...
      <div className="text-[7vh] font-extrabold text-customtext mt-[-20px] drop-shadow-xl">
        Fit & Strong
      </div>
        ...
        <div className="flex flex-col w-1/2 p-[40px] gap-[10%]">
          <div className="relative h-[60%]">
            ...
            <div className="absolute inset-0 flex flex-col justify-end items-start p-[50px] gap-4">
              ...
              <div className=" flex items-end justify-start text-white text-md w-[90%]">Pilates was started by a man, Joseph Pilates, for men at war and then it was transformed for ballet and contemporary dancers. So simply put Pilates will help you get the strength and agility of a warrior and also a lean, long, flexible body of a ballet dancer!</div>
      ...
      <div className="flex flex-col w-5/6 p-[40px] mt-[100px]">
          ...
          <div className=" text-black    flex flex-col w-2/5">
        ...
        <div className="flex flex-col mt-10 justify-center items-center w-full">
              ...
              <div className="bg-[#7E6D5B] w-full h-[500px] mt-[250px] flex flex-column justify-center items-center">
