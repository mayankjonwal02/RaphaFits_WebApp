  ...
  return (
    <div>
      <div className='relative w-full'>
        ...
        <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-5xl font-extrabold'>Contact Us</div>
      </div>


      <div className='w-full flex flex-row justify-evenly items-center my-[150px]'>
        ...
        <div className='w-1/3 flex flex-col justify-center items-start'>
          ...
          <div>If you have any feedback or questions about our clubs, our website or our services in general, please contact us by filling out the form.</div>
        ...
        <div className='w-1/3 flex flex-col justify-center items-start bg-[#F9F9F9] p-[50px]'>
      ...
      <div className='relative w-full'>
        ...
        <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-black bg-[#7E6D5B] flex flex-row justify-center items-start w-3/5 h-[250px] p-6'>
          <div className='w-1/3 flex flex-col justify-center items-center gap-5 '>
            ...
            <div className='text-md text-center'>Capitalized on hanging fruit to identify with additional</div>
            <div className='font-bold'>+91234567890</div>
          </div>
          ...
          <div className='w-1/3 flex flex-col justify-center items-center gap-5 '>
            ...
            <div className='w-1/2 h-[1px] bg-black'></div>
            <div className='text-md text-center'>Capitalized on hanging fruit to identify with additional</div>
            <div className='font-bold'>hello@strengthy.com</div>
          </div>
          ...
          <div className='w-1/3 flex flex-col justify-center items-center gap-5 ='>
            ...
            <div className='w-1/2 h-[1px] bg-black'></div>
            <div className='text-md text-center'>Capitalized on hanging fruit to identify with additional</div>
            <div className='font-bold'>123 King Dr.Oswego, NY 13126</div>
          </div>
        </div>
      </div>
